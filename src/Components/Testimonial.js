                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="relative mt-10 md:mt-24 md:order-2">
                        <div className="absolute -inset-x-1 inset-y-16 md:-inset-x-2 md:-inset-y-6">
                            <div className="w-full h-full max-w-5xl mx-auto rounded-3xl opacity-30 blur-lg filter" style={{ background: 'linear-gradient(90deg, #44ff9a -0.55%, #FFD700 22.86%, #8b44ff 48.36%, #ff6644 73.33%, #ebff70 99.34%)' }}></div>
                        </div>
                            ...
                            <div className="flex flex-col overflow-hidden shadow-xl">
                                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                    <div className="flex-1">
                                        ...
                                        <blockquote className="flex-1 mt-8">
                                            <p className="text-lg leading-relaxed text-gray-900 font-pj">“You won’t regret using this service! I was impressed by the quality of the results.”</p>
                                        </blockquote>
                                    </div>
                                    <div className="flex items-center mt-8">
                                        ...
                                        <div className="ml-4">
                                            <p className="text-base font-bold text-gray-900 font-pj">Ralph Edwards</p>
                                            <p className="mt-0.5 text-sm font-pj text-gray-600">Founder of 9GAG</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
